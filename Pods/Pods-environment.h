...
// JSONModel@thehtb
#define COCOAPODS_POD_AVAILABLE_JSONModel_thehtb
#define COCOAPODS_VERSION_MAJOR_JSONModel_thehtb 0
#define COCOAPODS_VERSION_MINOR_JSONModel_thehtb 9
#define COCOAPODS_VERSION_PATCH_JSONModel_thehtb 2
